...
static T_DjiReturnCode StartRecordVideo(void)
{
    ...
    /*!< Set Event */
    Dji_CameraSetEvent(CAM_EVENT_SET_START_RECORD);
...
static T_DjiReturnCode StopRecordVideo(void)
{
    ...
    /*!< Set Event */
    Dji_CameraSetEvent(CAM_EVENT_SET_STOP_RECORD);
...
static T_DjiReturnCode SetDigitalZoomFactor(dji_f32_t factor)
{
    ...
    /*!< Set Event */
    Dji_CameraSetEvent(CAM_EVENT_RESET_DIGITAL_ZOOM_FACTOR);
...
T_DjiReturnCode DjiTest_CameraEmuBaseStartService(void)
{
    ...
    /// setting video format type custom (gremsy custom)
